...

{
  ...
  or_sr(8);for (movLayer = movLayers; movLayer; movLayer = movLayer->next) { /* for each moving layer */
...
Region fence = {{0,LONG_EDGE_PIXELS}, {SHORT_EDGE_PIXELS, LONG_EDGE_PIXELS}}; /**<void mlAdvance(MovLayer *ml, MovLayer *ml1, MovLayer *ml2, Region *fence)
